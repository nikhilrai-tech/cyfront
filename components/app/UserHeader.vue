        ...
        <v-list-item three-line>
          <v-list-item-content>
            <v-list-item-title class="mb-2">
              Awards Earned ({{awards.earned}}/20)
              <v-menu open-on-hover :close-on-content-click="false" :nudge-width="200" offset-x>
                ...
                <v-card width="300">
                  ...
                  <v-divider />
                  <v-card-text>
                    Cyber3ra Awards will be provided accordingly based on how much you have completed your Profile,
          ...
          <v-list-item-icon>
            <v-icon color="success" large>mdi-trophy</v-icon>
          </v-list-item-icon>
        </v-list-item>
      </v-card>
    </v-col>
    ...
    <v-col class="text-center" cols="12" sm="6">
      <v-card>
        <v-list-item three-line>
          ...
          <v-list-item-icon>
            <v-icon color="#FFD54F" large>mdi-account-circle</v-icon>
          </v-list-item-icon>
        </v-list-item>
        <v-divider />
        <v-card-actions>
